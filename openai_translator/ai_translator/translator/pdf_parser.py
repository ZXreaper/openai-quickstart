...
from openai_translator.ai_translator.book import Book, Page, Content, ContentType, TableContent
from openai_translator.ai_translator.translator.exceptions import PageOutOfRangeException
