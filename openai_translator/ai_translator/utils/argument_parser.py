...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--config', type=str, default='/Users/zhangxu/D/openai-quickstart/openai_translator/config.yaml', help='Configuration file with model and API settings.')
